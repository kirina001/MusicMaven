...
public class report {
	...
	public void sendreport (String resultFile,String startTime)  {
		...
		map.put("email", "1051477499@qq.com");
		map.put("mailpass", "ilujxzusvkrjbdag");
		map.put("sendnick", "cj");
		map.put("host", "smtp.qq.com");
		map.put("recievers", "1051477499@qq.com");
		map.put("copylist", "1051477499@qq.com");
