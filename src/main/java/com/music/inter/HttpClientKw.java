...
import com.music.common.HttpDeleteWithBody;
...
//		//基于是否需要使用cookie，用不同方式创建httpclient实例。
	 ...
	 * @return
	 */
	public String doPutWithJson(String url, String json) throws Exception {
		// 接收返回数据的String
		String body = "";
		String result = "";
		// 设置代理地址，适用于需要用fiddler抓包时使用，不用时切记注释掉这句！
...
////////////////////////////////////
	/**
	 * 通过httpclient实现delete方法，其中包括代理地址的设置、头域添加和cookie使用。
	 * 
	 * @param url   接口的url地址
	 * @param param 接口的参数列表。
	 * @return
	 */
	public String doDeleteWithJson(String url, String param) throws Exception {
		// 接收返回数据的String
		String body = "";
		String result = "";
		// 设置代理地址，适用于需要用fiddler抓包时使用，不用时切记注释掉这句！
